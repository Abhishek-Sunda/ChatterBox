...
const SideBar = ({SelectedUser, setSelectedUser}) => {
  ...
  return (
    <div className={`bg-[#818582]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white ${SelectedUser ? "max-md-hidden" : ''} `}>
        ...
        {/* Logo + Menu Icon + Edit + logout */}
        <div onClick={()=>navigate('/profile')} className='flex justify-between items-center'>
        ...
        <div className='bg-[#282142] rounded-full flex items-center gap-2 py-3 px-4'>
            ...
            <input type="text" className='bg-transparent border-none outline-none text-white text-xs placeholder-[#c8c8c8] flex-1' placeholder='Select User...'/>
        </div>
